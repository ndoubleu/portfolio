...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>Ulugbek Akhmedov - Portfolio website</title>
        ...
        <meta property="og:site_name" content="BPortfolio website" />
        <meta property="og:locale" content="en_GB" />
        <title data-rh="true">Ulugbek Akhmedov - Portfolio website</title>
